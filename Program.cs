...
namespace ShareShooter
{
    class Program
    {
        ...
        public static void findLiveWebFiles()
        {
            ...
            if (webConfig == "")
            {
                Console.WriteLine("No web.config file found. No URLs can be determined.");
            } else
            {
            ...
            foreach (string aPath in writablePaths)
            {
                ...
                foreach (string webFile in webFiles)
                {
                    ...
                    // IIS
                    // TODO: Remove this check as it is no longer is high fidelity
                    //      - web.config properties should determine path
